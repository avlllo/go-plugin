...
func (p *FieldTestPlugin) LoadPath(ctx context.Context, pluginPath string) (fieldTest, error) {
...
func (p *FieldTestPlugin) LoadBinary(ctx context.Context, b []byte) (fieldTest, error) {
